...
face_samples = []
ids = []
id_counter = 0  # Variable global para contar los ID de los rostros
id_to_name = {}
...
# Función para registrar rostros y ejecutar la aplicación
def RegistrarRostrosApp():
    ...
    # Función principal para ejecutar la detección de rostros
    while True:
